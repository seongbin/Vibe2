...
function oBrowser() {
	...
	this.settings_context_menu = function (x, y) {
		...
		menu.AppendMenuSeparator();
		menu.AppendMenuItem(CheckMenuIf(ppt.doubleRowText), 10, "Double Track Line\tCtrl+D");
		menu.AppendMenuItem(CheckMenuIf(ppt.showGroupHeaders), 11, "Show Groups\tCtrl+G");
		menu.AppendMenuItem(CheckMenuIf(ppt.showRating), 12, "Show Ratings\tCtrl+R");
		menu.AppendMenuItem(CheckMenuIf(ppt.showScrollBar), 13, "Show Scrollbar\tCtrl+B");
		menu.AppendMenuItem(CheckMenuIf(ppt.showStripes), 14, "Show Stripes\tCtrl+E");
